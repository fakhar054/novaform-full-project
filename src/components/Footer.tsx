    ...
    <footer id="contact" className="bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2 text-left">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              The smart appointment system for modern pharmacies. AI-powered,
              easy to use, and designed to grow your business.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">© 2025 NovaFarm. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
