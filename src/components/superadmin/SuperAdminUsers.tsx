...
//   //   );
//   //   setDisplayUser(pendingUsers);
//   // };

//   // const handleStatusChange = (status) => {
//   //   if (status === "all") showAllusers();
//   //   else if (status === "active") showActiveUser();
//   //   else if (status === "suspended") showSuspendedUser();
//   //   else if (status === "pending") showPendingUsers();
//   // };

//   // const handlePlansChange = () => {};

//   const applyFilters = (status, plan) => {
...
//     applyFilters(status, planFilter);
//   };

//   // Handle plan change
//   const handlePlansChange = (plan) => {
//     setPlanFilter(plan);
//     applyFilters(statusFilter, plan);
//   };
                  ...
                  <TableBody>
                    {displayUsers.length > 0 ? (
                      displayUsers.map((user) => (
                        <TableRow
                          key={user.uuid} // Assuming 'uuid' is the unique identifier from Supabase
                          className="border-gray-200 hover:bg-gray-50"
                        >
                          <TableCell>
                            <div>
